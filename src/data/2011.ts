...
module data {
    ...
    export let trips2011: model.Trip[] = [
        {
        ...
        {
            purpose: "Google Waterloo interviews",
            travellers: ["Brett"],
